...
void runCorrCpu(DATA_TYPE pdata[M+1][N+1], DATA_TYPE psymmat[M+1][M+1], DATA_TYPE pstddev[M+1], DATA_TYPE pmean[M+1], DATA_TYPE pfloat_n, DATA_TYPE peps)
{
	int i, j, j1, j2;
...
int main(int argc, char** argv)
{
	...
	runCorrCpu(data, symmat, stddev, mean, float_n, eps);
